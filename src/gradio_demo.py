...
def mp3_to_wav(mp3_filename, wav_filename, frame_rate):
    # Convert FileStorage object to string before passing to AudioSegment
    mp3_file_path = str(mp3_filename)
    mp3_file = AudioSegment.from_file(file=mp3_file_path)
...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='crop', still_mode=False, use_enhancer=False, result_dir='./results/'):
        ...
        ref_eyeblink = "E:\\Sadtalker\\SadTalker-main\\examples\\ref_video\\ref_eyeblink_video.mp4"
        print(ref_eyeblink)

        ref_pose = "E:\\Sadtalker\\SadTalker-main\\examples\\ref_video\\ref_pose_video.mp4"
        #ref_pose = None
        print(ref_pose)
